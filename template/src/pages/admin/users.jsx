    ...
    <>
      <div className="flex flex-wrap mt-4">
        <div className="w-full mb-12 px-4">
          <div
            className="relative flex flex-col min-w-0 break-words w-full mb-0 shadow
            ...
            <div className="rounded-t mb-0 px-4 py-3 border-0">
              <div className="flex flex-wrap items-center">
                <div className="relative w-full px-4 max-w-full flex-grow flex-1">
                  <h3
                    className=" float-left font-semibold text-lg text
blueGray-700 "
                  >
                    Card Tables
                  </h3>
              ...
              <table className="items-center w-full bg-transparent border-collapse">
                <thead>
                  <tr>
                    <th
                      className={
                        "px-6 align-middle border border-solid py-3 textxs uppercase border-l-0 border-r-0 whitespace-nowrap font-semibold text-left bg-blueGray-50 textblueGray-500 border-blueGray-100"
                      }
                    >
                      User Name
                    </th>
                    ...
                    <th
                      className={
                        "px-6 align-middle border border-solid py-3 textxs uppercse border-l-0 border-r-0 whitespace-nowrap font-semibold text-left bg-blueGray-50 textblueGray-500 border-blueGray-100"
                      }
                    >
                      User Type
                    </th>
                ...
                <tbody>
                  {users.map((row) => (
                    <tr key={row.id}>
                      <td
                        className="border-t-0 px-6 align-middle border-l-0 
