					...
					<div className="w-full md:w-8/12 lg:w-6/12 xl:w-6/12 px-4">
						<div className="pt-32 sm:pt-0">
							<h2 className="font-semibold text-4xl text-blueGray-600">
								Example Template - A beautiful extension for
								Tailwind CSS.
							</h2>
							<p className="mt-4 text-lg leading-relaxed text-blueGray-500">
								Example Template is Free and Open Source. It
								does not change any of the CSS from{" "}
								<Link
									to="#"
									...
									<div className="relative flex flex-col mt-4">
										<div className="px-4 py-5 flex-auto">
											...
											<p className="mb-4 text-blueGray-500">
												Example Template comes with a
												huge number of Fully Coded CSS
												components.
											</p>
										</div>
									</div>
				...
				<div className="justify-center text-center flex flex-wrap mt-24">
					<div className="w-full md:w-6/12 px-12 md:px-4">
						...
						<p className="text-lg leading-relaxed mt-4 mb-4 text-blueGray-500">
							Example Template is a completly new product built
							using our past experience in web templates. Take the
					...
					<div className="flex flex-wrap justify-center">
						<div className="w-full md:w-5/12 px-12 md:px-4 ml-auto mr-auto md:mt-64">
							...
							<p className="text-lg font-light leading-relaxed mt-4 mb-4 text-blueGray-400">
								Since{" "}
								<Link to="#" className="text-blueGray-300">
									Tailwind CSS
								</Link>{" "}
